...
import '../components/CreateUserComponent.css';
...
class CreateUserComponent extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      alamat: "",
      deskripsi: "",
      showNotification: false, // Tambahkan state untuk menampilkan notifikasi
    };
  ...
  saveOrUpdateUser = (e) => {
    ...
    if (this.state.id === "_add") {
      UserService.createUser(user).then((res) => {
        this.setState({ showNotification: true }); // Menampilkan notifikasi setelah data berhasil ditambahkan
